...
export const ALL_PROJECT_TITLES_QUERY = gql`
  query {
    projects {
      title
      id
...
export const APPLICANTS_FOR_PROJECT_QUERY = gql`
  query APPLICANTS_FOR_PROJECT_QUERY($projectId: Int) {
    applicantsForProject(projectId: $projectId) {
      id
      answers
      foodPreference
      status
...
export const APPLICANT_FORM_FOR_PROJECT = gql`
  query APPLICANT_FORM_FOR_PROJECT($id: Int) {
    applicantFormForProject(id: $id) {
      id
      questions
    }
  }
